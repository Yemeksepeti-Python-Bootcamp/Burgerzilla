...
order_model=order_namespace.model(
    'Order',{
        ...
        'size':fields.Integer(description="An ID"),'size':fields.String(description="Size of order",required=True,enum=['SMALL','MEDIUM','LARGE','EXTRA_LARGE']),
        'menu':fields.Integer(description="Menu"),
        'quantity':fields.Integer(description="Quantity"),
        'customer':fields.Integer(description="customer"),
        'products':fields.String(description="List of all product id's",required=True),
        'order_status':fields.String(description="The status of the Order",required=True, enum=['PENDING','IN_TRANSIT','DELIVERED']),
        'flavour':fields.String(description="The Flavour or Extra thing into product!",required=True,)
    }
)
...
class OrderGetCreate(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return f"Exception Occured{str(e)}", HTTPStatus.BAD_REQUEST
